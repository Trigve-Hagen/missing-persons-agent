---
name: extract-files
description: Analyzes incoming JSON data feeds from external sources and map files related to a person to the files database table by generating valid SQL INSERT statements and download the file to the uploads file directory. Use when processing incoming data feeds.
license: MIT
metadata:
