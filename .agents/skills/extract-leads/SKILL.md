---
name: extract-leads
description: Analyzes incoming JSON data feeds from external sources and maps leads to the leads database table by generating valid SQL INSERT statements. Use when processing incoming data feeds.
license: MIT
metadata:
