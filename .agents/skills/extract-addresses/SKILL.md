...
description: Analyzes incoming JSON data feeds from external sources and map peoples addresses to the addresses database table by generating valid SQL INSERT statements. Use when processing incoming data feeds.
license: MIT
metadata:
