...
description: Analyzes incoming JSON data feeds from external sources and maps peoples aliases to the aliases database table by generating valid SQL INSERT statements. Use when processing incoming data feeds.
license: MIT
metadata:
