...
description: Analyzes incoming JSON data feeds from external sources and map peoples phone numbers to the phones database table by generating valid SQL INSERT statements. Use when processing incoming data feeds.
license: MIT
metadata:
...
# Extract Phone Number Data Workflow
