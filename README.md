...
Servielence that can be accessed by a program that takes available video footage and run facial recognition on it. Build a standard into security firmware that allows access.  
